...
#cat css/perfect-scrollbar.css css/help.css css/menu-group.css \
#        css/dropdown-menu.css css/tabbed-view.css css/draggable.css css/slider.css > tmp/styles4abcx.css
...
#        parse/abc_parse_key_voice.js parse/abc_tokenizer.js parse/abc_transposer.js parse/abc_rebalance.js > tmp/parse.js
...
#cat api/abc_tunebook.js data/abc_tune.js > tmp/tune.api.js
#cat edit/abc_selectors.js edit/abc_editarea.js > tmp/edit.js

#cat tmp/tune.api.js tmp/parse.js tmp/write.js tmp/svg.js tmp/edit.js tmp/midi.js tmp/abcjs-windows.js tmp/tablature.js > tmp/abcxjs.js
